  ...
  <footer class="page-footer">
    <div class="container">
      <div class="row justify-content-center mb-5">
        ...
        <div class="col-lg-3 py-3 interests">
          <h5>My Interests</h5>
          <ul class="footer-menu">
            <li class="nav-item">
              Research
        ...
        <div class="col-lg-3 py-3 social-media">
          <h5>Follow Me</h5>
      ...
      <div class="row">
        <div class="col-sm-6 py-2">
          <p id="copyright">
            &copy; 2022 <a href="/">IamPaul</a>. All
            rights reserved
          </p>
        </div>
...
<footer class="bg-white dark:bg-gray-900 hidden">
    
  <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
      <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
        © 2023 | <a href="/">IamPaul</a>. All Rights Reserved.
      </span>
      <div class="flex mt-4 space-x-6 sm:justify-center md:mt-0">
          <a target="_blank" href="https://linkedin.com/in/paul-eshun" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" /></svg>
              <span class="sr-only">LinkedIn</span>
          </a>
          
          <a target="_blank" href="https://twitter.com/@eshunbless" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" /></svg>
              <span class="sr-only">Twitter</span>
          </a>
          <a target="_blank" href="https://github.com/PaulBless" class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
